...
* @license   LICENSE.txt
*}
<div id="{$module_name|escape:'html':'UTF-8'}" class="panel product-tab pstab16">
    ...
    <div class="panel-footer">
        <a href="{$link->getAdminLink('AdminProducts')|escape:'html':'UTF-8'}" class="btn btn-default"><i class="process-icon-cancel"></i> {l s='Cancel' mod='pststockbar'}</a>
    </div>
</div>
