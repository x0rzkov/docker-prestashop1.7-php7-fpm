        ...
        <div class="row">
          <div class="col-lg-3 col-md-6">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <div class="row">
                  <div class="col-xs-3"> <i class="fa fa-percent fa-4x dashboard_bottom_text"></i> </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="panel panel-green">
              <div class="panel-heading">
                <div class="row">
                  <div class="col-xs-3"> <i class="fa fa-tags fa-4x dashboard_bottom_text"></i> </div>
                  <div class="col-xs-9 text-right">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="panel panel-yellow">
              <div class="panel-heading">
                <div class="row">
                  <div class="col-xs-3"> <i class="fa fa-shopping-cart fa-4x dashboard_bottom_text"></i> </div>
                  <div class="col-xs-9 text-right">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="panel panel-red">
              <div class="panel-heading">
                <div class="row">
                  <div class="col-xs-3"> <i class="fa icon-usd fa-4x dashboard_bottom_text"></i> </div>
                  <div class="col-xs-9 text-right">
